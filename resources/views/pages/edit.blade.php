        ...
        <form method="post" action="{{ route('update.post', $post->id) }}">
            ...
            <div class="mb-6">
                ...
                <textarea id="summary" name="summary" rows="4"
                    class="mt-2 block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500">{{ $post->summary }}</textarea>
            </div>
            ...
            <div class="mb-6">
                ...
                <textarea id="body" name="body" rows="6"
                    class="mt-2 block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500">{{ $post->body }}</textarea>
